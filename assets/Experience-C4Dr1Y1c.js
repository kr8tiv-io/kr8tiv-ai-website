import{a as Ge,r as s,b as F,j as e,s as De,e as lt,d as Ye,w as qe,X as Xe,T as Ze,y as wt,B as jt,q as bt,f as St,E as Pt,S as Tt}from"./r3f-B9mOlTRz.js";import{g as Ee}from"./gsap-DaXYigii.js";import{S as ut,s as Rt,a as ft}from"./index-CFWhjy_K.js";import{b as R,s as zt,I as It,am as _t,an as At,ao as Ct,ap as Ot,l as ie,aq as D,C as ve,ar as Et,w as Ft,V as ht,ai as Re,aj as ee,as as dt,o as Ke}from"./three-D0nhTf3g.js";Ee.registerPlugin(ut);const m=Math.PI/180,Lt=[{approach:{theta:62*m,phi:62*m,radius:12.5,ty:.75,fov:42},hold:{theta:96*m,phi:78*m,radius:5.4,tx:.15,ty:.35,fov:31},approachEase:"power2.out",holdEase:"sine.inOut",split:.5},{approach:{theta:148*m,phi:30*m,radius:9.4,ty:.55,fov:38},hold:{theta:182*m,phi:84*m,radius:5,tx:-.45,ty:.28,fov:34},approachEase:"power1.inOut",holdEase:"power1.out",split:.55},{approach:{theta:214*m,phi:96*m,radius:7.6,tx:.4,ty:.5,fov:46},hold:{theta:236*m,phi:81*m,radius:4.9,tx:1.05,ty:.34,fov:40,roll:-1.5*m},approachEase:"power2.inOut",holdEase:"sine.inOut",split:.45},{approach:{theta:262*m,phi:58*m,radius:6.2,ty:.4,fov:33},hold:{theta:292*m,phi:34*m,radius:13.5,ty:.9,fov:40},approachEase:"power2.in",holdEase:"power2.out",split:.35},{approach:{theta:320*m,phi:70*m,radius:10.5,ty:.7,fov:36},hold:{theta:352*m,phi:86*m,radius:4,tx:-.75,ty:.55,fov:33,roll:1.8*m},approachEase:"power3.out",holdEase:"sine.inOut",split:.4},{approach:{theta:384*m,phi:74*m,radius:7,ty:.4,fov:34},hold:{theta:412*m,phi:46*m,radius:15,ty:1,fov:42},approachEase:"sine.inOut",holdEase:"power1.inOut",split:.45}],$e={theta:-30*m,phi:76*m,radius:8.6,ty:.35,fov:35},de={theta:-52*m,phi:40*m,radius:30,ty:1.6,fov:46};function Je(){return typeof window<"u"&&window.innerWidth<768}function Gt(){const{camera:t}=Ge(),r=s.useRef(Je()),l=s.useRef(r.current?1.34:1),a=s.useRef(r.current?1.2:1),n=s.useRef(typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches),c=s.useRef({theta:de.theta,phi:de.phi,radius:de.radius,tx:0,ty:de.ty,tz:0,fov:de.fov,roll:0}),o=s.useRef(null),i=s.useRef(!1),d=s.useRef(new R),f=s.useRef(0),g=s.useRef(0),M=v=>({theta:v.theta,phi:v.phi,radius:v.radius*l.current,tx:v.tx??0,ty:v.ty??.3,tz:v.tz??0,fov:(v.fov??35)*a.current,roll:v.roll??0}),T=()=>{if(o.current)return;const x=1/(Rt.length+1-1),p=Ee.timeline({scrollTrigger:{trigger:".scroll-container",start:"top top",end:"bottom bottom",scrub:1.1,fastScrollEnd:!0,invalidateOnRefresh:!0}});Lt.forEach((y,w)=>{const P=w*x,z=y.split??.5;p.to(c.current,{...M(y.approach),duration:x*z,ease:y.approachEase??"power2.out"},P),p.to(c.current,{...M(y.hold),duration:x*(1-z),ease:y.holdEase??"sine.inOut"},P+x*z)}),o.current=p,ut.refresh()};return s.useEffect(()=>{const v=()=>{const x=Je();x!==r.current&&(r.current=x,l.current=x?1.34:1,a.current=x?1.2:1,o.current?.scrollTrigger?.kill(),o.current?.kill(),o.current=null,T())};return window.addEventListener("resize",v),()=>window.removeEventListener("resize",v)},[]),s.useEffect(()=>{const v=()=>{i.current||(i.current=!0,Ee.to(c.current,{...M($e),duration:3,ease:"power3.inOut",onComplete:()=>{T(),window.__kr8tiv_intro_zoom_complete=!0,window.dispatchEvent(new CustomEvent("intro-zoom-complete"))}}))};window.addEventListener("intro-complete",v);const x=setTimeout(()=>{c.current.radius>$e.radius*l.current+1&&v()},5e3);return()=>{window.removeEventListener("intro-complete",v),clearTimeout(x),o.current?.scrollTrigger?.kill(),o.current?.kill(),o.current=null}},[]),F((v,x)=>{const p=v.clock.elapsedTime,y=c.current,w=n.current?0:1,P=Math.min(Math.abs(window.__kr8tiv_scrollVel??0),2e3)/2e3,z=Math.sign(window.__kr8tiv_scrollVel??0)*P;f.current+=(P*.9*w-f.current)*Math.min(1,x*3),g.current+=(z*.9*m*w-g.current)*Math.min(1,x*3);const k=Math.sin(p*.07)*.055*w,X=Math.sin(p*.051+1.3)*.032*w,te=Math.sin(p*.089+.6)*.22*w,U=(Math.sin(p*.63)+Math.sin(p*1.17+2.1)*.5)*.006*w,Z=(Math.sin(p*.71+.9)+Math.sin(p*1.43)*.5)*.005*w,ce=Math.sin(p*.47+1.7)*.35*m*w,oe=y.theta+k+U,le=zt.clamp(y.phi+X+Z,.16,Math.PI-.16),se=Math.max(2.2,y.radius+te+f.current);t.position.set(se*Math.sin(le)*Math.sin(oe),se*Math.cos(le),se*Math.sin(le)*Math.cos(oe));const ue=r.current?1:0;d.current.set(y.tx,y.ty+ue,y.tz),t.lookAt(d.current);const xe=y.roll+ce+g.current;xe!==0&&t.rotateZ(xe);const _=t,E=y.fov+f.current*1.5;Math.abs(_.fov-E)>.01&&(_.fov=E,_.updateProjectionMatrix())}),null}const ne=.25,Q=ne+.03,$=new R(-1.15,Q,0),Dt=1.15,Se=.3,O=9,V=[[-.18,0,-.15],[.11,.012,.16],[.02,.024,-.03],[-.08,.036,.11],[.19,0,-.08],[-.21,.012,.06],[.06,.048,.05],[-.02,.06,-.13],[.14,.024,.1]],Qe=[.6,-.9,.25,-.4,1.2,-.15,.8,-.65,.35];function _e(t){const r=t%3,l=Math.floor(t/3);return new R(Dt-Se+r*Se,Q,-Se+l*Se)}const Pe=ne+.46,q=.85,N=.85;function kt(t,r){const l=t*t+r*r,a=Math.min(Math.sqrt(l),q+N-.01),n=Math.max(-1,Math.min(1,(a*a-q*q-N*N)/(2*q*N))),c=Math.acos(n);return[Math.atan2(r,Math.max(t,.001))+Math.atan2(N*Math.sin(c),q+N*Math.cos(c)),-c]}const J=4,Fe=2.6,Ut=O*J+Fe,pe=[0,.13,.2,.3,.56,.68,.74,.84,1],et=.2,tt=.74;function Wt(t){return t*t*(3-2*t)}function Ht({tier:t}){const r=t==="low",l=t==="medium",a=s.useRef(null),n=s.useRef(null),c=s.useRef(null),o=s.useRef(null),i=s.useRef(null),d=s.useRef(null),f=s.useRef(null),g=s.useRef(null),M=s.useRef([]),T=s.useRef([]),v=s.useRef(0),x=s.useRef(new Array(O).fill("pile")),p=s.useRef(new Array(O).fill(0)),y=s.useRef(null),w=s.useRef(null),[P,z]=s.useState(!1),k=s.useRef(new R),{raycaster:X,pointer:te,camera:U}=Ge(),Z=s.useMemo(()=>new It(2.9,2),[]),ce=s.useMemo(()=>new _t(2.2,1),[]),oe=s.useRef(null),le=s.useRef(null);s.useEffect(()=>{oe.current=new Float32Array(Z.attributes.position.array),le.current=new Float32Array(ce.attributes.position.array)},[Z,ce]);const se=s.useMemo(()=>new At(new R(0,0,1),0),[]),ue=s.useMemo(()=>new R,[]),xe=s.useCallback(()=>{X.setFromCamera(te,U),X.ray.intersectPlane(se,ue),k.current.copy(ue)},[X,te,U,se,ue]),_=s.useMemo(()=>new R,[]),E=s.useMemo(()=>new R,[]),ye=s.useMemo(()=>new R,[]),Ue=s.useMemo(()=>new R,[]),We=s.useMemo(()=>new R,[]),ge=s.useMemo(()=>new R,[]),ze=s.useRef(null),Ie=s.useRef(null),He=(A,j,b)=>{const I=ye.set($.x+V[b][0],Q+V[b][1],$.z+V[b][2]),C=_e(b);switch(j){case 0:return A.set(0,Pe+.55,.4);case 1:return A.set(I.x,I.y+.42,I.z);case 2:return A.set(I.x,I.y+.13,I.z);case 3:return A.set(I.x,I.y+.6,I.z);case 4:return A.set((I.x+C.x)/2,Q+.95,(I.z+C.z)/2);case 5:return A.set(C.x,C.y+.45,C.z);case 6:return A.set(C.x,C.y+.14,C.z);case 7:return A.set(C.x,C.y+.5,C.z);default:return A.set(0,Pe+.55,.4)}};F((A,j)=>{const b=A.clock.elapsedTime;P&&xe();const C=1+Math.min(Math.abs(window.__kr8tiv_scrollVel??0),1200)/1200*.9;v.current=(v.current+Math.min(j,.05)*C)%Ut;const fe=v.current,K=fe>=O*J,B=Math.min(Math.floor(fe/J),O-1),L=K?1:(fe-B*J)/J;if(K){const u=(fe-O*J)/Fe;for(let h=0;h<O;h++){const S=Math.sin(u*Math.PI*3+h*.3)*.5+.5;p.current[h]=Math.max(0,(1-u)*(.55+S*.45));const H=M.current[h];if(H&&x.current[h]==="placed"){const re=H.material;re.opacity=Math.max(0,1-u*1.6),u>.85&&(x.current[h]="pile")}}}else L>=et&&x.current[B]==="pile"&&(x.current[B]="carried"),L>=tt&&x.current[B]==="carried"&&(x.current[B]="placed",p.current[B]=1.4);let Y=0;for(;Y<pe.length-2&&L>pe[Y+1];)Y++;const mt=Wt(Math.max(0,Math.min(1,(L-pe[Y])/(pe[Y+1]-pe[Y]))));He(ye,Y,B);const vt=_.copy(ye);if(He(Ue,Y+1,B),vt.lerp(Ue,mt),K){const u=(fe-O*J)/Fe;_.set(Math.sin(u*Math.PI*2)*.8,Pe+.5,.5)}const xt=Math.atan2(_.z,_.x),yt=Math.max(.15,Math.sqrt(_.x*_.x+_.z*_.z)),[gt,Mt]=kt(yt,_.y-Pe);if(a.current){let u=xt-a.current.rotation.y;for(;u>Math.PI;)u-=Math.PI*2;for(;u<-Math.PI;)u+=Math.PI*2;a.current.rotation.y+=u*Math.min(1,j*7)}n.current&&(n.current.rotation.z+=(gt-n.current.rotation.z)*Math.min(1,j*9)),c.current&&(c.current.rotation.z+=(Mt-c.current.rotation.z)*Math.min(1,j*9)),o.current&&n.current&&c.current&&(o.current.rotation.z=-Math.PI/2-(n.current.rotation.z+c.current.rotation.z));const Ve=!K&&L>=et&&L<tt?.035:.075;d.current&&(d.current.position.x+=(Ve-d.current.position.x)*.25),f.current&&(f.current.position.x+=(-Ve-f.current.position.x)*.25),i.current&&i.current.getWorldPosition(E);for(let u=0;u<O;u++){const h=M.current[u];if(!h)continue;const S=h.material,H=x.current[u];if(H==="pile")h.position.set($.x+V[u][0],Q+V[u][1],$.z+V[u][2]),h.rotation.set(0,Qe[u],0),S.opacity=Math.min(1,S.opacity+j*1.5),S.emissive.setHex(16777215),S.emissiveIntensity=.32+Math.sin(b*1.4+u)*.06;else if(H==="carried")h.position.lerp(ye.set(E.x,E.y-.09,E.z),Math.min(1,j*18)),h.rotation.y+=(0-h.rotation.y)*.1,S.opacity=1,S.emissiveIntensity=.55;else{const re=_e(u);h.position.lerp(re,Math.min(1,j*10)),h.rotation.y+=(0-h.rotation.y)*.2,K||(S.opacity=1),S.emissive.setHex(13936723),S.emissiveIntensity=.5+Math.sin(b*2+u)*.08}}for(let u=0;u<O;u++){const h=T.current[u];if(!h)continue;if(!K){const H=x.current[u]==="placed"?.55:.05;p.current[u]+=(H-p.current[u])*Math.min(1,j*3)}const S=h.material;S.emissiveIntensity=p.current[u]}if(g.current){const u=!K&&(L>.13&&L<.28||L>.62&&L<.8),h=g.current.material;if(h.opacity+=((u?.22:0)-h.opacity)*.2,h.opacity>.01){const S=Math.max(.05,E.y-Q);g.current.position.set(E.x,E.y-S/2,E.z),g.current.scale.set(1,S,1)}}if(ze.current){const u=ze.current.material,h=r?.46:l?.5:.54;u.emissiveIntensity=h+Math.sin(b*.6)*.05}if(Ie.current&&(Ie.current.intensity=.1+Math.sin(b*.6)*.02),y.current&&oe.current){y.current.rotation.y=b*.015,y.current.rotation.x=Math.sin(b*.12)*.02;const u=y.current.material;if(u.opacity=P?.16:.06,u.emissiveIntensity=P?.2:.07,!r){const h=y.current.geometry.attributes.position,S=oe.current,H=k.current,re=P?.35:0;for(let G=0;G<h.count;G++){const we=S[G*3],je=S[G*3+1],be=S[G*3+2];We.set(we,je+.3,be);const Ne=We.distanceTo(H);if(Ne<2.2&&re>0){const he=1-Ne/2.2,ae=he*he*re;ge.set(we,je,be).normalize(),h.setXYZ(G,we+ge.x*ae,je+ge.y*ae,be+ge.z*ae)}else{const he=h.getX(G),ae=h.getY(G),Be=h.getZ(G);h.setXYZ(G,he+(we-he)*.08,ae+(je-ae)*.08,Be+(be-Be)*.08)}}h.needsUpdate=!0}}if(w.current){w.current.rotation.y=-b*.02,w.current.rotation.z=Math.sin(b*.1)*.015;const u=w.current.material;u.opacity=P?.1:.035,u.emissiveIntensity=P?.14:.05}});const W=s.useMemo(()=>new Ct({color:"#0c0d13",metalness:.92,roughness:.26,envMapIntensity:1.6,clearcoat:.4,clearcoatRoughness:.2}),[]),Me=s.useMemo(()=>new Ot({color:"#d4a853",emissive:"#d4a853",emissiveIntensity:.5,toneMapped:!1}),[]);return e.jsxs("group",{position:[0,0,0],children:[e.jsxs("mesh",{castShadow:!0,receiveShadow:!0,children:[e.jsx("boxGeometry",{args:[4.2,.5,2.2]}),e.jsx("meshPhysicalMaterial",{color:"#050508",metalness:.95,roughness:.08,envMapIntensity:2,clearcoat:.5,clearcoatRoughness:.1})]}),e.jsxs("mesh",{position:[0,.251,0],rotation:[-Math.PI/2,0,0],children:[e.jsx("planeGeometry",{args:[4.14,2.14]}),e.jsx("meshPhysicalMaterial",{color:"#07080e",metalness:.9,roughness:.12,clearcoat:1,clearcoatRoughness:.08,envMapIntensity:1.4})]}),e.jsxs("mesh",{ref:ze,position:[0,0,1.112],children:[e.jsx("boxGeometry",{args:[4,.06,.02]}),e.jsx("meshStandardMaterial",{color:"#d4a853",emissive:"#d4a853",emissiveIntensity:.5,toneMapped:!1})]}),e.jsxs("mesh",{position:[0,0,-1.112],children:[e.jsx("boxGeometry",{args:[4,.06,.02]}),e.jsx("meshStandardMaterial",{color:"#d4a853",emissive:"#d4a853",emissiveIntensity:.4,toneMapped:!1})]}),e.jsxs("mesh",{position:[2.112,0,0],children:[e.jsx("boxGeometry",{args:[.02,.04,2]}),e.jsx("meshStandardMaterial",{color:"#ffffff",emissive:"#ffffff",emissiveIntensity:.25,toneMapped:!1})]}),e.jsxs("mesh",{position:[-2.112,0,0],children:[e.jsx("boxGeometry",{args:[.02,.04,2]}),e.jsx("meshStandardMaterial",{color:"#ffffff",emissive:"#ffffff",emissiveIntensity:.25,toneMapped:!1})]}),e.jsxs("mesh",{position:[$.x,ne+.005,0],rotation:[-Math.PI/2,0,0],children:[e.jsx("ringGeometry",{args:[.52,.55,40]}),e.jsx("meshStandardMaterial",{color:"#d4a853",emissive:"#d4a853",emissiveIntensity:.18,transparent:!0,opacity:.55,toneMapped:!1})]}),Array.from({length:O},(A,j)=>{const b=_e(j);return e.jsxs("group",{children:[e.jsxs("mesh",{position:[b.x,ne+.004,b.z],rotation:[-Math.PI/2,0,0],children:[e.jsx("planeGeometry",{args:[.28,.22]}),e.jsx("meshStandardMaterial",{color:"#03030a",metalness:.8,roughness:.3})]}),e.jsxs("mesh",{ref:I=>{T.current[j]=I},position:[b.x,ne+.006,b.z],rotation:[-Math.PI/2,0,0],children:[e.jsx("ringGeometry",{args:[.13,.15,4,1,Math.PI/4]}),e.jsx("meshStandardMaterial",{color:"#d4a853",emissive:"#d4a853",emissiveIntensity:.05,transparent:!0,opacity:.9,toneMapped:!1})]})]},`cell-${j}`)}),Array.from({length:O},(A,j)=>e.jsxs("mesh",{ref:b=>{M.current[j]=b},position:[$.x+V[j][0],Q+V[j][1],$.z+V[j][2]],rotation:[0,Qe[j],0],children:[e.jsx("boxGeometry",{args:[.18,.012,.13]}),e.jsx("meshStandardMaterial",{color:"#e9e6dd",emissive:"#ffffff",emissiveIntensity:.32,transparent:!0,opacity:1,toneMapped:!1})]},`chit-${j}`)),e.jsxs("group",{ref:a,position:[0,ne,0],children:[e.jsx("mesh",{position:[0,.07,0],material:W,children:e.jsx("cylinderGeometry",{args:[.3,.34,.14,32]})}),e.jsx("mesh",{position:[0,.145,0],material:Me,children:e.jsx("torusGeometry",{args:[.24,.012,10,40]})}),e.jsx("mesh",{position:[0,.28,0],material:W,children:e.jsx("cylinderGeometry",{args:[.11,.14,.3,24]})}),e.jsxs("group",{ref:n,position:[0,.46,0],children:[e.jsx("mesh",{rotation:[Math.PI/2,0,0],material:W,children:e.jsx("cylinderGeometry",{args:[.11,.11,.22,24]})}),e.jsx("mesh",{rotation:[Math.PI/2,0,0],position:[0,0,.115],material:Me,children:e.jsx("torusGeometry",{args:[.08,.01,8,32]})}),e.jsx("mesh",{position:[q/2,0,0],rotation:[0,0,Math.PI/2],material:W,children:e.jsx("capsuleGeometry",{args:[.065,q-.12,6,16]})}),e.jsxs("group",{ref:c,position:[q,0,0],children:[e.jsx("mesh",{rotation:[Math.PI/2,0,0],material:W,children:e.jsx("cylinderGeometry",{args:[.08,.08,.18,20]})}),e.jsx("mesh",{rotation:[Math.PI/2,0,0],position:[0,0,.095],material:Me,children:e.jsx("torusGeometry",{args:[.06,.008,8,28]})}),e.jsx("mesh",{position:[(N-.14)/2,0,0],rotation:[0,0,Math.PI/2],material:W,children:e.jsx("capsuleGeometry",{args:[.05,N-.26,6,14]})}),e.jsxs("group",{ref:o,position:[N-.14,0,0],children:[e.jsx("mesh",{material:W,children:e.jsx("cylinderGeometry",{args:[.05,.06,.1,16]})}),e.jsx("mesh",{position:[0,-.04,0],material:Me,children:e.jsx("torusGeometry",{args:[.045,.007,8,24]})}),e.jsx("mesh",{ref:d,position:[.075,-.1,0],material:W,children:e.jsx("boxGeometry",{args:[.018,.1,.05]})}),e.jsx("mesh",{ref:f,position:[-.075,-.1,0],material:W,children:e.jsx("boxGeometry",{args:[.018,.1,.05]})}),e.jsx("object3D",{ref:i,position:[0,-.14,0]})]})]})]})]}),e.jsxs("mesh",{ref:g,children:[e.jsx("cylinderGeometry",{args:[.035,.06,1,12,1,!0]}),e.jsx("meshBasicMaterial",{color:"#d4a853",transparent:!0,opacity:0,blending:D,depthWrite:!1,side:ie})]}),e.jsx("mesh",{ref:y,geometry:Z,position:[0,.3,0],onPointerEnter:()=>z(!0),onPointerLeave:()=>z(!1),children:e.jsx("meshStandardMaterial",{color:"#b0b0b0",emissive:"#ffffff",emissiveIntensity:.12,wireframe:!0,transparent:!0,opacity:.06,toneMapped:!1})}),e.jsx("mesh",{ref:w,geometry:ce,position:[0,.3,0],children:e.jsx("meshStandardMaterial",{color:"#909090",emissive:"#cccccc",emissiveIntensity:.08,wireframe:!0,transparent:!0,opacity:.035,toneMapped:!1})}),e.jsx("pointLight",{ref:Ie,position:[0,.6,0],color:"#d4a853",intensity:.1,distance:4.5,decay:2})]})}const Vt=`
varying vec2 vUv;
...
`,lo=De({uTime:0,uBaseSize:.4,uColor:new ve("#667799"),uOpacity:.035,uTexture:null},ao,no),uo=De({uTime:0,uBaseSize:.2,uColor:new ve("#d4a853"),uOpacity:.06,uTexture:null},io,co);lt({FogParticleMaterial:lo,GoldParticleMaterial:uo});function ke(t,r,l=2){const a=document.createElement("canvas");a.width=t,a.height=t;const n=a.getContext("2d"),c=t/2,o=n.createRadialGradient(c,c,0,c,c,c);o.addColorStop(0,r),o.addColorStop(.3/l,r),o.addColorStop(.6,"rgba(0,0,0,0.02)"),o.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=o,n.fillRect(0,0,t,t);const i=new dt(a);return i.needsUpdate=!0,i}const Ae=400;function fo(){const t=s.useRef(null),r=s.useMemo(()=>ke(128,"rgba(100,120,160,0.15)",1.5),[]),l=s.useMemo(()=>{const a=new Float32Array(Ae*3),n=new Float32Array(Ae*3);for(let o=0;o<Ae;o++){const i=Math.random()*Math.PI*2,d=.8+Math.random()*6;a[o*3]=Math.cos(i)*d,a[o*3+1]=(Math.random()-.5)*5,a[o*3+2]=Math.sin(i)*d,n[o*3]=Math.random()*100,n[o*3+1]=.3+Math.random()*.7,n[o*3+2]=Math.random()*Math.PI*2}const c=new Re;return c.setAttribute("position",new ee(a,3)),c.setAttribute("aSeed",new ee(n,3)),c},[]);return F(a=>{t.current&&(t.current.uTime=a.clock.elapsedTime)}),e.jsx("points",{geometry:l,children:e.jsx("fogParticleMaterial",{ref:t,uTexture:r,transparent:!0,blending:D,depthWrite:!1})})}const Ce=80;function ho(){const t=s.useRef(null),r=s.useMemo(()=>ke(64,"rgba(255,255,255,0.15)",2),[]),l=s.useMemo(()=>{const a=new Float32Array(Ce*3),n=new Float32Array(Ce*3);for(let o=0;o<Ce;o++){const i=Math.random()*Math.PI*2,d=.5+Math.random()*2.5;a[o*3]=Math.cos(i)*d,a[o*3+1]=(Math.random()-.5)*2,a[o*3+2]=Math.sin(i)*d,n[o*3]=Math.random()*100,n[o*3+1]=.5+Math.random()*1,n[o*3+2]=Math.random()*Math.PI*2}const c=new Re;return c.setAttribute("position",new ee(a,3)),c.setAttribute("aSeed",new ee(n,3)),c},[]);return F(a=>{t.current&&(t.current.uTime=a.clock.elapsedTime)}),e.jsx("points",{geometry:l,children:e.jsx("fogParticleMaterial",{ref:t,uTexture:r,uColor:new ve("#ffffff"),uBaseSize:.15,uOpacity:.03,transparent:!0,blending:D,depthWrite:!1})})}const Te=200;function po(){const t=s.useRef(null),r=s.useMemo(()=>ke(64,"rgba(212,168,83,0.25)",2),[]),l=s.useMemo(()=>{const a=new Float32Array(Te*3),n=new Float32Array(Te*3);for(let o=0;o<Te;o++){const i=o/Te*Math.PI*2;a[o*3]=Math.cos(i)*2,a[o*3+1]=.3,a[o*3+2]=Math.sin(i)*2,n[o*3]=Math.random()*100,n[o*3+1]=.3+Math.random()*.7,n[o*3+2]=i}const c=new Re;return c.setAttribute("position",new ee(a,3)),c.setAttribute("aSeed",new ee(n,3)),c},[]);return F(a=>{t.current&&(t.current.uTime=a.clock.elapsedTime)}),e.jsx("points",{geometry:l,children:e.jsx("goldParticleMaterial",{ref:t,uTexture:r,transparent:!0,blending:D,depthWrite:!1})})}function mo(){return e.jsxs("group",{children:[e.jsx(fo,{}),e.jsx(ho,{}),e.jsx(po,{})]})}const at=`
varying vec2 vUv;
