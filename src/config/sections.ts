...
export const sections: Section[] = [
  ...
  },
  {
    ...
    label: 'Meet Your KIN',
    title: 'Bespoke AI.\nZero headache.',
    copy: "KIN by kr8tiv is a bespoke concierge AI companion built to make frontier tech irresistibly easy. We configure everything end-to-end \u2014 voice, Telegram, WhatsApp, and secure phone-to-computer control \u2014 so you can use the latest models without touching APIs, servers, or prompt engineering. Customized to your life, always-on supported, and simple enough that even your grandmother can use it.",
    hudData: [
      { label: 'SERVICE', value: 'BESPOKE', unit: 'CONCIERGE' },
      { label: 'INTERFACE', value: 'VOICE', unit: '\u00B7 TG \u00B7 WA' },
      { label: 'CONTROL', value: 'PHONE', unit: '\u2194 PC' },
      { label: 'MODELS', value: 'FRONTIER', unit: 'OPEN' },
      { label: 'TECH REQUIRED', value: 'ZERO' },
    ],
    hudColor: '#ffffff',
    alignment: 'right',
    ctas: [
      { text: 'Meet Your KIN \u2192', href: 'https://meetyourkin.com' },
      { text: '@meetyourkin on X \u2192', href: 'https://x.com/meetyourkin' },
    ],
  },
  {
    angle: (3 * Math.PI) / 2,
