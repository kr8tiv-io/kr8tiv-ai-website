...
export default function NavigationBar() {
  ...
  return (
    <nav
      ref={navRef}
      className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3 sm:py-4 transition-all duration-500 ${
        scrolled
      ...
      <div className="flex items-center gap-2.5 sm:gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a href="https://www.linkedin.com/company/kr8tivai" target="_blank" rel="noopener noreferrer"
             className="text-white/30 hover:text-white/80 transition-colors duration-300" title="LinkedIn">
          ...
          <a href="https://github.com/kr8tiv-ai" target="_blank" rel="noopener noreferrer"
             className="text-white/30 hover:text-white/80 transition-colors duration-300" title="GitHub">
